...
const SchoolOfProduct = () => {
  return (
    <div className='bg-gray-500 py-10'>
      <div className='w-[80%] bg-red-400 m-auto container'>
        <h1 className='font-bold text-center lg:text-5xl md:text-4xl text-2xl pt-5'>SCHOOL OF ENGINEERING</h1>

        <div>
          <h2 className='text-2xl font-bold pt-5'>Learning Path</h2>
          <div className='space-y-5'>
            ...
            <p>At the initial stage, students who are enrolled 
